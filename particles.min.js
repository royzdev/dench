...
var pJS = function(e, a) {
    ...
    i.fn.particle = function(e, a, t) {
        ...
        this.vy = this.vy * Math.random())) : (this.vx = n.x + Math.random() - .2,
    ...
    i.fn.particle.prototype.draw = function() {
        ...
        a.shape) {
        case "circle":
            i.canvas.ctx.arc(a.x, a.y, t, 0, 2 * Math.PI, !2);
            break;
        case "edge":
        ...
        i.interactivity.events.onclick.enable && i.interactivity.el.addEventListener("click", function() {
            ...
            i.interactivity.events.onclick.enable)
                ...
                case "repulse":
                    ...
                    i.tmp.repulse_finish = !2,
                    setTimeout(function() {
                        i.tmp.repulse_clicking = !8
        ...
        "" != i.particles.shape.image.src)
            if ("svg" == e) {
                ...
                a.onreadystatechange = function(e) {
                    4 == a.readyState && (25 == a.status ? (i.tmp.source_svg = e.currentTarget.response,
